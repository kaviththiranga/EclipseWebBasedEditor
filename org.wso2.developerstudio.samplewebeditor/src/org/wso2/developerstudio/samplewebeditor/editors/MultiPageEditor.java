...
public class MultiPageEditor extends MultiPageEditorPart implements IResourceChangeListener{
	...
	private SampleTextAreaWebEditor webEditor;
	 ...
	 */
	void createPage1() {
		webEditor = new SampleTextAreaWebEditor();
		int index;
		try {
			index = addPage(webEditor, getEditorInput());
	...
	protected void pageChange(int newPageIndex) {
		...
		if (newPageIndex == 0) {
			String dirtyContent = webEditor.getDirtyContent();
			IDocumentProvider dp = textEditor.getDocumentProvider();
			IDocument doc = dp.getDocument(textEditor.getEditorInput());
			doc.set(dirtyContent);
		} else if (newPageIndex == 1) {
			IDocumentProvider dp = textEditor.getDocumentProvider();
			IDocument doc = dp.getDocument(textEditor.getEditorInput());
			String dirtyContent = doc.get();
			webEditor.setDirtyContent(dirtyContent);
		}
	}
	/**
